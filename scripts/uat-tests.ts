 ...
 * Run these tests in staging environment before production deployment
 */
...
class CompanyAdminJourneyTests {
  static async run() {
...
async function runUATTests() {
  ...
  await HealthCheckTests.run();

  console.log('\n📋 Testing: Authentication Flow');
  await AuthenticationTests.run();

  console.log('\n📋 Testing: Super Admin Journey');
  await SuperAdminJourneyTests.run();

  console.log('\n📋 Testing: Company Admin Journey');
  await CompanyAdminJourneyTests.run();

  console.log('\n📋 Testing: Employee Journey');
  await EmployeeJourneyTests.run();
