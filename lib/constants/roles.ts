...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  [USER_ROLES.SUPER_ADMIN]: 'Full system access, can manage all companies and users',
  [USER_ROLES.PLATFORM_ADMIN]: 'Can manage platform settings and multiple companies',
  [USER_ROLES.COMPANY_ADMIN]: 'Can manage all aspects of their company',
  [USER_ROLES.HR_ADMIN]: 'Can manage employees and benefits within their company',
 ...
 */
export function normalizeLegacyRole(legacyRole: string | undefined): UserRole | undefined {
